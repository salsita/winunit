    ...
    const TCHAR* message /* NULL */, ...)
{
    ...
    exception.AppendMessage(_T("%s(%d) : error C9999: WIN_ASSERT_EQUAL failed. Expected: <%s> (\"%s\"); Actual: <%s> (\"%s\"). "), 
        fileName,
        lineNumber,
    ...
    const TCHAR* message /* NULL */, ...)
{
    ...
    AssertExceptionT exception;
    exception.AppendMessage(_T("%s(%d) : error C9999: WIN_ASSERT_NOT_EQUAL failed. \"%s\" and \"%s\" were expected different, but were same (<%s>). "), 
        fileName,
        lineNumber,
    ...
    const TCHAR* message /* NULL */, ...)
{
    ...
    AssertExceptionT exception;
    exception.AppendMessage(_T("%s(%d) : error C9999: WIN_ASSERT_STRING_EQUAL failed. "), 
        fileName, lineNumber);
#ifdef _UNICODE
    ...
    const TCHAR* message /* NULL */, ...)
{
    ...
    AssertExceptionT exception;
    exception.AppendMessage(_T("%s(%d) : error C9999: WIN_ASSERT_ZERO failed: \"%s\" expected to be zero, but was <%s>. "),
        fileName, lineNumber,
    ...
    const TCHAR* message /* NULL */, ...)
{
    ...
    AssertExceptionT exception;
    exception.AppendMessage(_T("%s(%d) : error C9999: WIN_ASSERT_NOT_ZERO failed: \"%s\". "),
        fileName, lineNumber,
    ...
    const TCHAR* message /* NULL */, ...)
{
    ...
    AssertExceptionT exception;
    exception.AppendMessage(_T("%s(%d) : error C9999: WIN_ASSERT_NULL failed: \"%s\" expected to be NULL, but was <%s>. "),
        fileName, lineNumber,
        expressionString,
        ToString(nullExpression, buffer, ARRAYSIZE(buffer)));
    ...
    const TCHAR* message /* NULL */, ...)
{
    ...
    AssertExceptionT exception;
    exception.AppendMessage(_T("%s(%d) : error C9999: WIN_ASSERT_NOT_NULL failed: \"%s\". "),
        fileName, lineNumber,
...
{
    AssertExceptionT exception;
    exception.AppendMessage(_T("%s(%d) : error C9999: WIN_ASSERT_FAIL failed. "),
        fileName,
        lineNumber);
    ...
    const TCHAR* message, ...)
{
    ...
    AssertExceptionT exception;
    exception.AppendMessage(_T("%s(%d) : error C9999: WIN_ASSERT_TRUE failed: \"%s\". "), fileName, lineNumber, expressionString);
    ...
    const TCHAR* message /* NULL */, ...)
{
    ...
    AssertExceptionT exception;
    exception.AppendMessage(_T("%s(%d) : error C9999: WIN_ASSERT_FALSE failed: \"%s\". "), fileName, lineNumber, expressionString);
        ...
        const TCHAR* message /* NULL */, ...)
{
    ...
    AssertExceptionT exception;
    exception.AppendMessage(_T("%s(%d) : error C9999: WIN_ASSERT_WINAPI_SUCCESS failed: \"%s\". (%s) "), 
    ...
    const TCHAR* message /* NULL */, ...)
{
    ...
    exception.AppendMessage(_T("%s(%d) : error C9999: WIN_ASSERT_THROWS failed: Exception %s not thrown by \"%s\". "),
        fileName, lineNumber,
...
inline void AssertExceptionA<size>::AppendMessage(const char* message, va_list args)
{
    ...
    const int bufferSize = min(size, INT_MAX);
...
namespace WinUnit
{
    ...
    inline void Trace(const wchar_t* formatString, ...)
    {
        ...
        ::_vsnwprintf_s(buffer, ARRAYSIZE(buffer), _TRUNCATE,
            formatString, args);
    ...
    inline void Trace(const char* formatString, ...)
    {
        ...
        _vsnprintf_s(buffer, ARRAYSIZE(buffer), _TRUNCATE,
            formatString, args);
